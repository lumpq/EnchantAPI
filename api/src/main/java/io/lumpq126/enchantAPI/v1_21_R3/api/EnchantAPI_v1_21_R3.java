package io.lumpq126.enchantAPI.v1_21_R3.api;

import io.lumpq126.enchantAPI.v1_21_R3.enchantment.CustomEnchantment_v1_21_R3;

public class EnchantAPI_v1_21_R3 {
    private static EnchantAPI_v1_21_R3 instance;

    public static EnchantAPI_v1_21_R3 getInstance() {
        if (instance == null) {
    ...
    public static void setInstance(EnchantAPI_v1_21_R3 api) {
        instance = api;
    }
